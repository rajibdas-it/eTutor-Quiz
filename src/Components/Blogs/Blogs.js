      ...
      <div>
        ...
        >
          <div className="max-w-xl mb-5 md:mx-auto sm:text-center lg:max-w-2xl">
            ...
            <p className="text-base text-gray-700 md:text-lg text-justify">
              <span className="text-2xl font-bold italic">React Router</span> is
              ...
              way of having a more seamless user experience.
            </p>
          </div>
        ...
        >
          <div className="max-w-xl mb-5 md:mx-auto sm:text-center lg:max-w-2xl">
            ...
            <p className="text-base text-gray-700 md:text-lg text-justify">
              ...
              state management using Redux. Context API is a (kind of) new
              feature added in version 16.3 of React that allows one to share
              state across the entire app (or part of it) lightly and with ease.
        ...
        >
          <div className="max-w-xl mb-5 md:mx-auto sm:text-center lg:max-w-2xl">
            ...
            <p className="text-base text-gray-700 md:text-lg text-justify">
              <span className="text-2xl font-bold italic">useRef Hook</span>{" "}
              allows you to persist values between renders. useRef is like a
              “box” that can hold a mutable value in its current property. It
              can be used to store a mutable value that does not cause a
              re-render when updated. useRef creates a plain JavaScript object.
              It can be used to access a DOM element directly. When we need to
              send value or child component we can use forwardRef. useRef
